        ...
        <div class="bg-gradient-to-r from-yellow-600 to-orange-500 px-6 py-5">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('admin.roles.index') }}" 
                   class="bg-white text-yellow-600 px-4 py-2 rounded-lg font-semibold shadow hover:bg-yellow-50">
            ...
            <form action="{{ route('admin.roles.update', $rol->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $rol->name) }}"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent @error('name') border-red-500 @enderror">
                    @error('name')
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="submit" 
                            class="px-6 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition duration-200 font-semibold">
